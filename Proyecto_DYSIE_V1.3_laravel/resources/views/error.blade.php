    ...
    <style>
        * {
        ...
        .notfound .notfound-404 h1>span {
            text-shadow: 2px 2px 0 #01e185, -2px -2px 0 #01e185, 0 0 8px #01e185
        }
...
<body>
    <div id="notfound">
        <div class="notfound">
            ...
            <p>Es posible que la página que está buscando se haya eliminado, se haya cambiado el nombre o no esté disponible temporalmente.
            </p>
