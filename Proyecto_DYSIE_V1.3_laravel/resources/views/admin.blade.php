...
<head>
    ...
    <link rel="shortcut icon" href="href="{{ asset('assets/justLogoDysie.png') }} type="image/x-icon">
    <link
...
<body>
    ...
    <main>
        <div class="contenedor__todo">
            ...
            <form id="formularioL" method="POST" action="{{route('admin_dashboard')}}" class="formulario__login">
