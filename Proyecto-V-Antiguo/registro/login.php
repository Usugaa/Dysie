            ...
            <div class="contenedor__login-register">
                <form id="formularioL" method="POST" action="procesar_login.php" class="formulario__login">
                    ...
                    <div class="contenedor-linkVolver">
                        <a class="link-Volver" href="../recuperar/recuperar.php">¿Olvidaste tu contraseña? </a>
                    </div>
                </form>
                <form id="formulario" method="POST" action="procesar_registro.php" class="formulario__register">
                    ...
                    <input type="date" id="txt_fecha" name="txt_fecha" required><br>
                    <p style="color:white;">Grado:</p><br>
                        <select id="select_grado" name="select_grado" class="form-control" style="width: 100%; height: 40px; border-radius: 5px; padding: 10px; box-sizing: border-box;" required>
